...
import { updateCorporateProfileAction } from "@/lib/actions/updateCorporateProfileAction";

export default function CorporateForm({ user }: any) {
	const [formState, formAction] = useFormState(updateCorporateProfileAction, {
		message: null,
		errors: undefined,
	});
